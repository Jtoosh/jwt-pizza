# Deliverable 12: Penetration Testing - James Teuscher and Bryce Lasson
...
- Another takeaway for me was the importance of metrics. I was able to detect some of my peer's more subtle attacks/infiltrations because of my logging when these attacks weren't visible on the front end. This shows me that metrics and logging are critical for detecting _all_ types of attacks.
- I think another takeaway for me is the importance of understanding all of the code, _from a security standpoint_. After Deliverable 1, and throughout the class, I felt I could confidently say that I knew the code for JWT Pizza pretty well. But, my understanding, even if it was good, was from more of a functional, software engineering standpoint. When it came to my security understanding of the code: what was safe, what was vulnerable, and _why_ those things were safe or vulnerable, my understanding was, admittedly, virtually nonexistent. I think after this experience, I am more motivated to learn cyber security and be able to analyze code from a security standpoint.
